...
public class CreatingStreams {
	public static void main(String[] args) {
		...
		Stream<String> strimstrim = Arrays.stream(strArr);
		ArrayList<Integer> intList = new ArrayList<Integer>();
		intList.add(1);
		intList.add(2);
		intList.add(3);
		intList.add(4);
		Stream<Integer> strimt = intList.stream();
		...
		randStack.push(new Random());
		randStack.push(new Random());
		Stream<Random> strimstack =  randStack.stream();
		...
		dQueue.push(2.0);
		dQueue.push(3.0);
		Stream<Double> strique = dQueue.stream();
